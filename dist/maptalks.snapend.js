...
var SnapEndPoint = function (_maptalks$Class) {
    ...
    SnapEndPoint.prototype._createInspectExtent = function _createInspectExtent(coordinate) {
        ...
        var lefttop = map.pointToCoordinate(new maptalks.Point([x - tolerance, y - tolerance]), zoom);
        var righttop = map.pointToCoordinate(new maptalks.Point([x + tolerance, y - tolerance]), zoom);
        var leftbottom = map.pointToCoordinate(new maptalks.Point([x - tolerance, y + tolerance]), zoom);
        var rightbottom = map.pointToCoordinate(new maptalks.Point([x + tolerance, y + tolerance]), zoom);
        return {
            type: 'Feature',
            properties: {},
            geometry: {
