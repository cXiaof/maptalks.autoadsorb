...
var Autoadsorb = function (_maptalks$Class) {
    ...
    Autoadsorb.prototype._registerDrawToolEvents = function _registerDrawToolEvents() {
        ...
        drawTool.on('mousemove', function (e) {
            return _this10._resetCoordinates(e.target._geometry || e);
        }, this);
        drawTool.on('drawvertex', function (e) {
            return _this10._resetCoordsAndPoint(e);
        }, this);
        drawTool.on('drawend', function (e) {
            return _this10._resetCoordinates(e.geometry || e);
        }, this);
    };
    ...
    Autoadsorb.prototype._offDrawToolEvents = function _offDrawToolEvents() {
        ...
        if (this.drawTool) {
            ...
            drawTool.off('drawstart', function (e) {
                return _this11._resetCoordsAndPoint;
            }, this);
            drawTool.off('mousemove', function (e) {
                return _this11._resetCoordinates;
            }, this);
    ...
    Autoadsorb.prototype._offGeometryEvents = function _offGeometryEvents() {
        ...
        if (this.geometry) {
            ...
            geometry.off('shapechange', function (e) {
                return _this13._setEditCoordinates;
            }, this);
            geometry.off('editrecord', function (e) {
                return _this13._upGeoCoords;
            }, this);
        }
    };
...
typeof console !== 'undefined' && console.log('maptalks.autoadsorb v0.1.0');
